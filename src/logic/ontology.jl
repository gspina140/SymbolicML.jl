...
struct Point{T<:Real} <: AbstractTemporalOntology
    x::T
end
...
struct Interval{T<:Real} <: AbstractTemporalOntology
...
struct Rectangle{T<:Real} <: AbstractSpatialOntology
...
struct Cube{S<:Real,T<:Real} <: AbstractSpatioTemporalOntology
